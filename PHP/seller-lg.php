...
if (isset($_POST['username'])) {
    ...
    if ($user) {
        ...
        header('Location: seller-reset.php?username=' . urlencode($username));
        exit();
    } else {
...
<body  >
 ...
 <div class="herritage-link2" style="left:670px; top: 180px;">
        ...
        <a href="seller-reset.php">   <button style="border-radius: 5px;width:170px"  >Reset Password</button></a>
            </div>
