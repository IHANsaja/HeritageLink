       ...
       <video width="100%"  autoplay muted playsinline loop>
        ...
        <form action=" seller-login.php"method="POST">
            ...
            <div class="login-child5" style="top: 30px;">
                <button id="sellerTab" class="active" style="border-radius: 4px;" onclick="window.location.href='seller-login.php'">SELLER</button>
                <button id="userTab"  style="left:740px; border-radius: 4px;" onclick="window.location.href='login.php'">USER</button>
            </div>
            ...
            <div class="password" style="left:630px; top: 270px;">Password
				...
				<div type="submit" style="width:550px;"><a style="color:#541E3A ;left:800px;font-family:poppins; font-size:14px;" onclick="window.location.href='seller-lg.php'">Forgot password?</a></div>
            </div>
